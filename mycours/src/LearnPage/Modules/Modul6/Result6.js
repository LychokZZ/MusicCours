        ...
        return (
            <div className="repeat">
                ...
                <div className="material">
                    ...
                    <Link className="bar" to="/Modul6"><button onClick={()=>localStorage.setItem("ProgresMod6", JSON.stringify(50))} className="but-result">Пройти знову!</button></Link>   
                </div>
            </div>
        )
    }
    Goods=()=> {
        localStorage.setItem("TestSix", JSON.stringify(false))
        return(
            <div className="repeat">
                <div className="Malo">
