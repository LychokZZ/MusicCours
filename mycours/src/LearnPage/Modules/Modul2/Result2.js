        ...
        return (
            <div className="repeat">
                ...
                <div className="material">
                    ...
                    <Link className="bar" to="/Modul2"><button onClick={()=>localStorage.setItem("ProgresMod2", JSON.stringify(50))} className="but-result">Пройти знову!</button></Link>   
                </div>
            </div>
        )
    }
    Goods=()=> {
        localStorage.setItem("TestTwo", JSON.stringify(false))
        return(
            <div className="repeat">
                <div className="Malo">
