        ...
        return (
            <div className="repeat">
                ...
                <div className="material">
                    ...
                    <Link className="bar" to="/Modul1"><button onClick={()=>localStorage.setItem("ProgresMod1", JSON.stringify(50))} className="but-result">Пройти знову!</button></Link>   
                </div>
            </div>
        )
    }
    Goods=()=> {
        localStorage.setItem("TestOne", JSON.stringify(false))
        return(
            <div className="repeat">
                <div className="Malo">
