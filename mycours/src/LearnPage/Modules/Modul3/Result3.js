        ...
        return (
            <div className="repeat">
                ...
                <div className="material">
                    ...
                    <Link className="bar" to="/Modul3"><button onClick={()=>localStorage.setItem("ProgresMod3", JSON.stringify(50))} className="but-result">Пройти знову!</button></Link>   
                </div>
            </div>
        )
    }
    Goods=()=> {
        localStorage.setItem("TestThree", JSON.stringify(false))
        return(
            <div className="repeat">
                <div className="Malo">
