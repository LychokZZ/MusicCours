        ...
        return (
            <div className="repeat">
                ...
                <div className="material">
                    ...
                    <Link className="bar" to="/Modul5"><button onClick={()=>localStorage.setItem("ProgresMod5", JSON.stringify(50))} className="but-result">Пройти знову!</button></Link>   
                </div>
            </div>
        )
    }
    Goods=()=> {
        localStorage.setItem("TestFive", JSON.stringify(false))
        return(
            <div className="repeat">
                <div className="Malo">
